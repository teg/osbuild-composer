...
func (r *DistroRegister) register(distro Distro) {
	name := distro.Name()
...
func (r *DistroRegister) GetDistro(name string) Distro {
...
func (r *DistroRegister) FromHost() (Distro, error) {
